				...
				<tr class="top">
					<td colspan="2">
						<table>
							<tr>
								<td class="title">
									<a style="text-decoration: none" onclick="window.print()" href="{{ url('print-invoice/'.$orders->id) }}">
										<img src="{{ asset('assets/images/ariecakelogo.png') }}" style="width: 17%; max-width: 300px" />
									</a>
								</td>
