      ...
      <div class="dashboard-content">
        <div class="row">
          <div class="col-12">
            ...
            @endif
            <form action="{{ url('update-productkar/'.$products->id) }}" method="post" enctype="multipart/form-data">
              @method('PUT')
              @csrf
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select name="cate_id" class="form-control">
                                <option value="{{ $products->cate_id }}" selected>{{ $products->category->name }}</option>
