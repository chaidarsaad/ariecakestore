        ...
        <div class="card shadow">
            <div class="card-body">
                <div class="row">
                    ...
                    <hr>
                    <label class="me-3">Harga : Rp {{ number_format($products->price) }}</label>
                    ...
                    <hr>
                    @if($products->qty > 0)
                        <label class="badge bg-success">Stok Ada</label>
                    @else
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-9">
                            ...
                            @endif
                            <button type="button" class="btn btn-success me-3 addToWishlist float-start">Tambah ke Wishlist <i class="fa fa-heart"></i> </button>
                        </div>
                    </div>
                </div>
            </div>
