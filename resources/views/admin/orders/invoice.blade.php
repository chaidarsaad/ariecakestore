            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="invoice-wrapper">
                        <a href="{{ url('export-pdfinvoice/.$id') }}" class="btn btn-primary">Cetak Invoice</a>
						<div class="invoice-top">
							<div class="row">
								<div class="col-sm-6">
									<div class="invoice-top-left">
										<h2 class="client-company-name">Nama Costumer</h2>
										<h6 class="client-address">{{ $orders->fname }}</h6>
										<h4>Tanggal Pesanan</h4>
										<h5>{{ date('d-m-Y', strtotime($orders->created_at)) }}</h5>
									</div>
								</div>
								<div class="col-sm-6">
