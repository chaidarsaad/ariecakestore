          ...
          <div class="row">
            ...
            >
              <a class="component-categories d-block" href="#">
                ...
                <p class="categories-text">Pastry</p>
              </a>
            </div>
            <div
              class="col-6 col-md-3 col-lg-2"
            ...
            >
              <a class="component-categories d-block" href="#">
                ...
                <p class="categories-text">Tart</p>
              </a>
            </div>
            <div
              class="col-6 col-md-3 col-lg-2"
            ...
            >
              <a class="component-categories d-block" href="#">
                ...
                <p class="categories-text">Pancake</p>
              </a>
            </div>
            <div
              class="col-6 col-md-3 col-lg-2"
            ...
            >
              <a class="component-categories d-block" href="#">
                ...
                <p class="categories-text">Roll Cake</p>
              </a>
            </div>
            <div
              class="col-6 col-md-3 col-lg-2"
            ...
            >
              <a class="component-categories d-block" href="#">
                ...
                <p class="categories-text">Dessert</p>
              </a>
            </div>
            <div
              class="col-6 col-md-3 col-lg-2"
            ...
            >
              <a class="component-categories d-block" href="#">
                ...
                <p class="categories-text">donuts</p>
              </a>
            </div>
          </div>
        </div>
